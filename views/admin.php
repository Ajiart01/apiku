 ...
 * Akuari.my.id | ccpprogrammers@gmail.com
...
//Application Title
define('APP_TITLE', 'Admin Panel Akuari');
...
$auth_users = array(
    'admin' => '$2y$10$J11P7flev/f5h9QoBS6VBuhTpYAW.GrTJ47yDzSZr8lm4Llr6bnui', //admin@123
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="#" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Akuari.my.id</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<head>
    ...
    <meta name="author" content="Akuari.my.id">
