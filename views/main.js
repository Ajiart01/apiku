...
function includeHTML() {
 ...
 let audio = document.querySelector('#audio')
  ...
  let dj = ['https://cdn-api.akuari.my.id/jawerhayam.mp3'];
      ...
      audio.src = dj[Math.floor(Math.random() * dj.length)]
...
var num = data.value
let text = num.toLocaleString( {style:"minimumFractionDigits"});
