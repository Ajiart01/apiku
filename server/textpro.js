...
const { textpro } = require('../scraper/textproo')
...
const UrlTextpro = {
	neon: 'https://textpro.me/create-glowing-neon-light-text-effect-online-free-1061.html',
  	...
  	halloweenskeleton: 'https://textpro.me/create-a-cinematic-horror-text-effect-1045.html',
...
router.get('/sketch', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.sketch, text)
	try {
...
router.get('/batman', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.batman, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/lightglow', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.lightglow, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/business', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.business, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/summer2', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.summer2, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/summer', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.summer, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/neon-love', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.neon, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/led', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.led, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/3dgolden', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.dgolden, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/christmas', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.christmas, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/3drainbow', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.drainbow, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/halloweenskeleton', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.halloweenskeleton, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/space', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.space, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/transformer', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.transformer, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/thunder', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.thunder, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/magma', async (req, res) => {
	...
	var hasil = await textpro(UrlTextpro.magma, text)
	try {
		var Buffer = await fetch(hasil, {
		headers: {
		"User-Agent": "Opera/9.80 (X11; Linux i686; U; ru) Presto/2.8.131 Version/11.11"
...
router.get('/cinematichorror', async (req, res) => {
	...
	if (!text_2) return res.json({ message: 'Masukan parameter Text_2'})
		...
		var hasil = await textpro(UrlTextpro.cinematichorror, 
                            [text, text_2])
...
router.get('/scraper-1', async (req, res) => {
	...
	var hasil = await textpro(link, text)
	try {
	res.json({
